...
Statt eines ursprünglich geplanten Protokolls wird OpenID 2.0\footnote{\url{http://openid.net/specs/openid-authentication-2_0.html}} (mit gewissen Einschränkungen)
...
Eine Beispielkonfiguration für nginx findet sich im doc-Ordner des Repositories.

\subsection{Import der Token}
Die Liste der Token und zugehörigen Daten muss regelmäßig importiert werden.
Für die Übertragung von Mitgliederverwaltung zum ID-Server existieren spezielle Skripte.
Diese sind im Repository unter "`export"' zu finden und werden in der beiliegenden README-Datei erklärt.
