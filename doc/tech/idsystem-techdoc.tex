...
Die Datei sollte unbedingt gesichert werden. Ohne die dort eingestellten Secrets ist die Datenbank unbrauchbar. Es kann sinnvoll sein, die Datei read-only zu setzen.
...
tokenimport.inc.php bietet eine Funktion, die für den Import genutzt werden kann.
